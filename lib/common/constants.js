...
Object.keys(constants).forEach(constantKey => {
  overridenConstants[constantKey] = `${PREFIX}_${constants[constantKey]}`;
})

// same. we change the extension proptocol used 
overridenConstants.EXTENSION_PROTOCOL = 'electron-chrome-extension';
